...
class ItiStudent(models.Model):
    ...
    def _check_capcity_track(self):
        count_track=len(self.track_id.student_ids)
        # print("Capcity ",self.track_id.student_ids)
        if count_track > self.track_capacity:
            raise UserError(f'This {self.track_id.name} track is full sorry not opend now')
